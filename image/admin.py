...
class FavoriteAdmin(admin.ModelAdmin):
    ...
    list_display_links = ("format_image",)
    list_filter = (
        "image__publisher__publishing_group",
    ...
    def format_user_image(self, obj):
        if obj.user.profile_image_uri:
            return format_html(
                '<img src="{}" width="50" style="border-radius: 25px" />',
                obj.user.profile_image_uri,
            )
