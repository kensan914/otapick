...
urlpatterns = [
    ...
    path(
        ...
        main.redirect.redirectBlogsGView,
        name="redirectBlogsGView",
    ),
    path(
        "search/member/blog/<int:group_id>/<str:ct>/",
        main.redirect.redirectBlogsMView,
        name="redirectBlogsMView",
    ),
    path(
        "download/<int:group_id>/<int:blog_ct>/<int:order>/",
        main.redirect.redirectImageView,
        name="redirectImageView",
    ),
    path(
        "search/member/", main.redirect.redirectMembersView, name="redirectMembersView"
    ),
