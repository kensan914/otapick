...
export class HorizontalLoader extends React.Component {
  render() {
    return (
      <div
        className="loader-ellips infinite-scroll-request my-5"
...
export class BlogViewLoader extends React.Component {
  render() {
    return (
      <div
        className="container text-center mx-auto d-flex align-items-center"
        style={{ height: 400 }}
      >
        <div>
          ...
          <div className="write_box">
            <div className="img-wrap">
              <img
                src={this.props.loadingImageUrl}
                className="img-fluid mb-5 col-lg-5 col-md-8 col-11"
                alt="Responsive image"
              />
            </div>

            <div className="img-wrap-before"></div>
          </div>
