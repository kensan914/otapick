...
urlpatterns = [
    ...
    path('blog/<int:group_id>/<int:blog_ct>/',
         views.blogDetailAPIView, name='blogDetailAPI'),
    path('blogs/', views.blogListAPIView, name='blogListAPI'),
    path('blogs/<int:group_id>/', views.blogListAPIView, name='blogList_G_API'),
    path('blogs/<int:group_id>/<str:ct>/',
         views.blogListAPIView, name='blogList_M_API'),
    path('blogs/info/', views.blogListInfoAPIView, name='blogListInfo_R_API'),
    path('blogs/info/<int:group_id>/',
         views.blogListInfoAPIView, name='blogListInfo_G_API'),
    path('blogs/info/<int:group_id>/<str:ct>/',
         views.blogListInfoAPIView, name='blogListInfo_M_API'),
    path('search-suggestions/', views.searchSuggestionsAPIView,
         name='searchSuggestionsAPI'),
    path('search-suggestions/init/', views.searchSuggestionsInitAPIView,
    ...
    path('images/<int:group_id>/<str:ct>/',
         views.imageListAPIView, name='imageList_M_API'),
    path('images/info/', views.imageListInfoAPIView, name='imageListInfo_R_API'),
    path('images/info/<int:group_id>/',
         views.imageListInfoAPIView, name='imageListInfo_G_API'),
    path('images/info/<int:group_id>/<str:ct>/',
         views.imageListInfoAPIView, name='imageListInfo_M_API'),
    path('image/<int:group_id>/<int:blog_ct>/<int:order>/',
         views.imageDetailAPIView, name='imageDetailAPI'),
    path('relatedImages/<int:group_id>/<int:blog_ct>/<int:order>/',
         views.relatedImageListAPIView, name='relatedImageListAPI'),
