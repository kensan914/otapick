...
urlpatterns = [
    ...
    path(
        "search-suggestions/",
        views.searchSuggestionsAPIView,
        name="searchSuggestionsAPI",
    ),
    path(
        "search-suggestions/init/",
        views.searchSuggestionsInitAPIView,
    ...
    path(
        ...
        views.imageDetailAPIView,
        name="imageDetailAPI",
    ),
    path(
        "relatedImages/<int:group_id>/<int:blog_ct>/<int:order>/",
        views.relatedImageListAPIView,
    ...
    path(
        ...
        views.favoriteAPIView,
        name="favoriteAPI",
    ),
    path("favorites/", views.favoriteListAPIView, name="favoriteListAPI"),
    path("favorites/info/", views.favoriteListInfoAPIView, name="favoriteListInfoAPI"),
