...
from api.models.main.models import Member, Blog


class Command(BaseCommand):
    help = (
        "graduate. 卒業するメンバーのテキストをまとめて保存。"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "-e", "--external", action="store_true", help="set external. default:False"
        )
    ...
    def handle(self, *args, **options):
        ...
        if Member.objects.filter(
            belonging_group__group_id=options["group"], ct=options["ct"]
        ):
