...
class MeSerializer(UserSerializer):
    ...
    def update(self, instance, validated_data):
        instance.fav_groups.set(validated_data.get(
            'fav_groups_pks', instance.fav_groups))
...
class FavMembersSerializer(serializers.Serializer):
    ...
    members = serializers.ListField(
        child=FavMembersChildSerializer(), required=False)
    ...
    def create(self, validated_data):
        ...
        fav_members_data = {'fav_groups_pks': [],
                            'fav_member_sakura_pk': None, 'fav_member_hinata_pk': None, }
    ...
    def validate_members(self, members_child):
        ...
        for member_child in members_child:
            members = Member.objects.filter(
                belonging_group__group_id=member_child['group_id'], ct=member_child['ct'])
            if members.exists():
